...
**Platform:** platform-foundation · **Owner:** `platform-core` · **Phase:** P1 · **Language:** nestjs-ts

Register/login/verify/reset; JWT+refresh; sessions; MFA-ready (Keycloak-backed).
