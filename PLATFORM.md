...
The eight top-level platform directories are **fixed across Phase 1 → Phase 6**. Services are _filled in_ per phase; the skeleton never reorganizes. Full design: [docs/Brain_Repository_Architecture.md](docs/Brain_Repository_Architecture.md).
