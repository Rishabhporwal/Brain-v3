...
export const sidebarNavSections: SidebarNavSection[] = [
  {
    items: [{ title: 'Dashboard', path: 'dashboard', icon: IconDashboard }],
  },
  {
    title: 'Data Points',
    items: [
      ...
      { title: 'COD vs Prepaid', path: 'cod-prepaid', icon: IconCurrencyDollar, featureKey: 'cod_prepaid' },
      {
        ...
        icon: IconRoute,
        featureKey: 'pincode_intelligence',
      },
  ...
  },
  {
    items: [
      ...
      { title: 'Products', path: 'products', icon: IconShoppingBag, featureKey: 'products' },
      {
        ...
        path: 'first-product-cascade',
        icon: IconRoute,
        featureKey: 'first_product_cascade',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: 'Ad campaigns',
        path: 'settings/ad-campaigns',
        icon: IconBrandMeta,
        featureKey: 'ad_campaigns',
        minRole: 'ANALYST',
      },
